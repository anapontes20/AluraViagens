...
//
//  Created by Caio Serpa on 19/07/22.
//
...
class ViewController: UIViewController {
    ...
    // MARK: - OUTLETS criar referencias
       
    @IBOutlet weak var viagensTableView: UITableView!
    
    // var viagensTableView: UITableView!
...
// MARK: Extensao do hometable ate o main / delegate
